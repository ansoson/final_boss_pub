...
public abstract class CS1971FrontEnd {
	 ...
	 *                              	to onTick
	 */
	protected abstract void onTick(long nanosSincePreviousTick) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, IOException, TransformerException;

	protected abstract void onLateTick() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException;
	 ...
	 */
	protected abstract void onMouseClicked(MouseEvent e) throws IOException, InvocationTargetException, TransformerException, NoSuchMethodException, InstantiationException, IllegalAccessException;
	 ...
	 */
	protected abstract void onStartup() throws IOException, ParserConfigurationException, TransformerException, InvocationTargetException, SAXException, NoSuchMethodException, InstantiationException, IllegalAccessException;
